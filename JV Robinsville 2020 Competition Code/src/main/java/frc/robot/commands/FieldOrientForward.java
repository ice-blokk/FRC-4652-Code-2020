...
public class FieldOrientForward extends CommandBase {
  ...
  public FieldOrientForward(DriveTrain drivetrain, AHRS ahrs,
  ...
  public void initialize() {
    if((ahrs.getAngle() > 0 && ahrs.getAngle() < 180) || (ahrs.getAngle() < 0 && ahrs.getAngle() > -180)) {
      targetAngle = 0;
    }
    else {
      targetAngle = drivetrain.round360((int)Math.round(ahrs.getAngle()));
    }
  }
