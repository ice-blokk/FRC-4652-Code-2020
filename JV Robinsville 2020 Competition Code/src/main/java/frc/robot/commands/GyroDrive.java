...
public class GyroDrive extends CommandBase {
  ...
  public GyroDrive(DriveTrain drivetrain, AHRS ahrs, DoubleSupplier forwardSpeed, DoubleSupplier strafeSpeed) {
  ...
  public void execute() {
    ...
    drivetrain.swerveDrive(curvedForwardSpeed, curvedStrafeSpeed, angleOffset);

    SmartDashboard.putNumber("angleOffset", angleOffset);
    SmartDashboard.putNumber("targetAngle", targetAngle);
    SmartDashboard.putNumber("Gyro forward speed", forwardSpeed.getAsDouble());
    SmartDashboard.putNumber("Gyro strafe speed", strafeSpeed.getAsDouble());
  }
